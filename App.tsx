              ...
              {authStep === 'register' && (
                <form onSubmit={handleRegister} className="space-y-3 max-h-[60vh] overflow-y-auto pr-1 scroll-smooth">
                   ...
                   <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <input 
                            ...
                            className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-blue-500 text-sm text-slate-900 dark:text-white"
                        />
                      </div>
                      <div>
                   ...
                   <div>
                      ...
                      <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full pl-8 pr-3 py-2 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-blue-500 text-sm text-slate-900 dark:text-white"
                        />
                      </div>
                   </div>
                   ...
                   {targetRole === UserRole.PATIENT && (
                       <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-100 dark:border-blue-900/50 space-y-3">
                           <p className="text-[10px] font-bold text-blue-800 dark:text-blue-400 uppercase">Infos Patient</p>
                           <div>
                              <label className="block text-[10px] text-blue-700 dark:text-blue-300 mb-1">Date de Naissance</label>
                              <div className="relative">
                                <Calendar className="absolute left-3 top-2.5 text-blue-400 dark:text-blue-500" size={14} />
                                <input 
                                    type="date" required value={regData.dob}
                                    onChange={(e) => setRegData({...regData, dob: e.target.value})}
                                    className="w-full pl-8 pr-3 py-2 bg-white dark:bg-slate-900/30 border border-blue-200 dark:border-blue-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500 text-sm text-slate-900 dark:text-white"
                                />
                              </div>
                           </div>
                           <div>
                              <label className="block text-[10px] text-blue-700 dark:text-blue-300 mb-1">Genre</label>
                              <select 
                                value={regData.gender}
                                onChange={(e) => setRegData({...regData, gender: e.target.value})}
                                className="w-full px-3 py-2 bg-white dark:bg-slate-900/30 border border-blue-200 dark:border-blue-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500 text-sm text-slate-900 dark:text-white"
                              >
                   ...
                   {targetRole === UserRole.DOCTOR && (
                       <div className="bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-lg border border-indigo-100 dark:border-indigo-900/50 space-y-3">
                           <p className="text-[10px] font-bold text-indigo-800 dark:text-indigo-400 uppercase">Infos Professionnelles</p>
                           <div>
                              <label className="block text-[10px] text-indigo-700 dark:text-indigo-300 mb-1">Numéro de Licence</label>
                              <div className="relative">
                                <Hash className="absolute left-3 top-2.5 text-indigo-400 dark:text-indigo-500" size={14} />
                                <input 
                                    type="text" required value={regData.licenseNumber}
                                    onChange={(e) => setRegData({...regData, licenseNumber: e.target.value})}
                                    className="w-full pl-8 pr-3 py-2 bg-white dark:bg-slate-900/30 border border-indigo-200 dark:border-indigo-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500 text-sm text-slate-900 dark:text-white"
                           ...
                           <div className="grid grid-cols-2 gap-2">
                               <div>
                                  <label className="block text-[10px] text-indigo-700 dark:text-indigo-300 mb-1">Spécialité</label>
                                  <input 
                                      type="text" required value={regData.specialty}
                                      onChange={(e) => setRegData({...regData, specialty: e.target.value})}
                                      className="w-full px-3 py-2 bg-white dark:bg-slate-900/30 border border-indigo-200 dark:border-indigo-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500 text-sm text-slate-900 dark:text-white"
                                  />
                               </div>
                               <div>
                                  <label className="block text-[10px] text-indigo-700 dark:text-indigo-300 mb-1">Hôpital/Clinique</label>
                                  <input 
                   ...
                   {targetRole === UserRole.LAB && (
                       <div className="bg-emerald-50 dark:bg-emerald-900/20 p-3 rounded-lg border border-emerald-100 dark:border-emerald-900/50 space-y-3">
                           <p className="text-[10px] font-bold text-emerald-800 dark:text-emerald-400 uppercase">Infos Laboratoire</p>
                           <div>
                              <label className="block text-[10px] text-emerald-700 dark:text-emerald-300 mb-1">Numéro d'Accréditation</label>
                              <div className="relative">
                                <Hash className="absolute left-3 top-2.5 text-emerald-400 dark:text-emerald-500" size={14} />
                                <input 
                                    type="text" required value={regData.licenseNumber}
                                    onChange={(e) => setRegData({...regData, licenseNumber: e.target.value})}
                                    className="w-full pl-8 pr-3 py-2 bg-white dark:bg-slate-900/30 border border-emerald-200 dark:border-emerald-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-400 dark:focus:ring-emerald-500 text-sm text-slate-900 dark:text-white"
